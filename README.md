...
## Quickstart
    ...
    pytest -q                      # all green: machinery + record lint
    ...
    python -m core.intake "raw feedback text" --source "call with Dana"
...
decide at your pace — decisions never default. Scheduling any phase
unattended (cron, hooks) is the Docker-cage trigger: container first.
